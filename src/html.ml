...
module HTMLCanvas = struct
  ...
  external setTextAlign: canvasRenderingContext2D -> string -> unit = "textAlign" [@@bs.set]
  ...
  external arcTo: canvasRenderingContext2D -> int -> int -> int -> int -> int -> unit = "arcTo" [@@bs.send]
  ...
  external fill: canvasRenderingContext2D -> unit = "fill" [@@bs.send]
  external translate: canvasRenderingContext2D -> int -> int -> unit = "translate" [@@bs.send]
  external save: canvasRenderingContext2D -> unit = "save" [@@bs.send]
