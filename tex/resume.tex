...
\begin{enumerate}[label=]
	...
	\begin{enumerate}[label= *]
	\parskip=-0.1em
        \item\tabulardef{4cm}{}{Developing program logics for reasoning about concurrent,
            randomized programs}
        \item\tabulardef{4cm}{}{Designed programming language for verifying
	...
	\begin{enumerate}[label= *]
	\parskip=-0.1em
        \item\tabulardef{4cm}{}{Worked on an extension of Martin-L\"{o}f type theory with strictly
