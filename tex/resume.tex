...
\begin{enumerate}[label=]
	...
	\parskip=-0.1em
        \item\tabulardef{4cm}{}{Studied the duality of effects and coeffects in call-by-push-value.
            Formalized several properties of type-and-effect system in Agda. (paper under review, OOPSLA 2024)}
        \item\tabulardef{4cm}{}{Shared a fresh perspective on logical relations using literate Agda
            (paper under review, CPP 2024)}
        \item\tabulardef{4cm}{}{Developed a tutorial for normalization-by-evaluation (NbE) in
	...
	\begin{enumerate}[label= *]
	\parskip=-0.1em
        \item Designed core system for modeling types of activities, leading implementation
	...
	\headerrow
  	...
  	\begin{itemize}[label= *]
	\parskip=-0.1em
\item\tabulardef{5cm}{}{Worked on a proposal for an extension to the Glasgow Haskell Compiler which would allow binding existential type variables to data constructors in patterns}
	\end{itemize}
\end{enumerate}
