...
\begin{enumerate}[label=]
	...
	\begin{enumerate}[label= *]
	\parskip=-0.1em
        \item Studied effects and coeffects in call-by-push-value
        \item Wrote a paper on logical relations using literate Agda
        \item Developed a tutorial in Agda on normalization by evaluation
        \item Formalized a type system and semantics for a functional network programming language
	\end{enumerate}
