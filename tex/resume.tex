...
\begin{enumerate}[label=]
    ...
    \item Programming languages and their design, type systems, formal methods, functional programming, strongly typed programming languages, computer science education
\end{enumerate}
