...
\begin{enumerate}[label=]
	...
	\headerrow
  	...
  	\begin{itemize}[label= *]
	\parskip=-0.1em
\item\tabulardef{5cm}{}{Worked on a \href{https://github.com/ghc-proposals/ghc-proposals/pull/96}{proposal} for an extension to the Glasgow Haskell Compiler to allow binding existential type variables to data constructors in patterns}
	\end{itemize}
\end{enumerate}
